...
namespace ego_planner
{
  ...
  void EGOReplanFSM::init(ros::NodeHandle &nh)
  {
    ...
    waypoint_nh_.reset(new ros::NodeHandle(node_, &waypoint_queue_));
    ...
    odometry_nh_.reset(new ros::NodeHandle(node_, &odometry_queue_));
    ...
    execFSM_nh_.reset(new ros::NodeHandle(node_, &execFSM_queue_));
    ...
    checkCollision_nh_.reset(new ros::NodeHandle(node_, &checkCollision_queue_));
